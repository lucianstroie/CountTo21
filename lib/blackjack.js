...
function Game() {
  ...
  this.dealer = new Dealer(this.game);
    ...
    document.addEventListener("DOMContentLoaded", () =>{
      // Get the modal
      this.game.modal = document.getElementById('myModal');

      // Get the button that opens the modal
      this.game.btn = document.getElementById("myBtn");

      // Get the <span> element that closes the modal
      this.game.span = document.getElementsByClassName("close")[0];
      ...
      // When the user clicks on <span> (x), close the this.game
      span.onclick = function() {
          this.game.style.display = "none";
      }

      // When the user clicks anywhere outside of the this.game, close it
