...
function Game() {
  ...
  // while (this.deck.cards.length > 4 && this.player.bankroll > 0) {
    ...
    // this.player1.placeBet(this.dealer, 10);
    // this.player2.placeBet(this.dealer, 10);
    // this.player3.placeBet(this.dealer, 10);
    ...
    // this.dealer.payBets(this.player1);
    // this.dealer.payBets(this.player2);
    // this.dealer.payBets(this.player3);
    console.log(this.player1);
    console.log(this.player2);
    console.log(this.player3);
    debugger
    this.players.forEach(player => player.hand.discardCards());
    // this.player1.hand.discardCards();
    // this.player2.hand.discardCards();
    // this.player3.hand.discardCards();
